function render_point_shop_window() {
    ...
    let $psBox_3_btn_1 = $('<input>').addClass('psBox_3_btns').attr({'id':'psBox_3_btn_1','type':'button', 'value':'ALL'});
    ...
    let $psBox_2_box_1_img = $('<img>').addClass('psBox_2_box_1_img').attr({'id':'psBox_2_box_1_img','src':'resource/G00001284055.jpg'});
    ...
    let $psBox_2_box_1_box_rank = $('<h4>').addClass('psBox_2_box_1_box_rank')
        ...
        .text('1위');
    let $psBox_2_box_2_img = $('<img>').addClass('psBox_2_box_2_img').attr({'id':'psBox_2_box_2_img','src':'resource/G00001284055.jpg'});
    ...
    let $psBox_2_box_2_box_rank = $('<h4>').addClass('psBox_2_box_2_box_rank')
        ...
        .text('2위');
    let $psBox_2_box_3_img = $('<img>').addClass('psBox_2_box_3_img').attr({'id':'psBox_2_box_3_img','src':'resource/G00001284055.jpg'});
    ...
    let $psBox_4_box_1_img = $('<img>').addClass('psBox_4_box_1_img').attr({'id':'psBox_4_box_1_img','src':'resource/G00001284055.jpg'});
    ...
    let $psBox_4_box_2_img = $('<img>').addClass('psBox_4_box_2_img').attr({'id':'psBox_4_box_2_img','src':'resource/G00001284055.jpg'});
    ...
    let $psBox_4_box_3_img = $('<img>').addClass('psBox_4_box_3_img').attr({'id':'psBox_4_box_3_img','src':'resource/G00001284055.jpg'});
    ...
    let $psBox_4_box_4_img = $('<img>').addClass('psBox_4_box_4_img').attr({'id':'psBox_4_box_4_img','src':'../resource/G00001284055.jpg'});
